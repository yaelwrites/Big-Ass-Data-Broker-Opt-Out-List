...
### Epsilon
[Epsilon IBA](https://legal.epsilon.com/optout) is a service that provides targeted advertising. You can opt out of their platform [with the following link](https://legal.epsilon.com/optout). Note that it's a cookie-based opt out, so if you already delete cookies or block them, this may not be necessary or may not work.

### ☠ 💐 Experian
To opt-out of the sale of your personal information and data, follow the [instructions](https://consumerprivacy.experian.com/) and send your complete name and mailing address to <optout@experian.com>. You may also include any name variations, additional email addresses and telephone numbers that you want opted out.

To remove yourself from Experian's other methods of targeted advertising, visit their [privacy opt-out page](https://www.experian.com/privacy/opting_out) and follow the links for each opt-out method.
...
### ☠ 💐 LexisNexis
Follow the instructions in the [opt-out form](https://optout.lexisnexis.com/). Provide the required information depending on the option selected at the 'Opt Out Reason' step.
...
### ☠ 💐 TransUnion
Complete the [Opt-out/Limitation request](https://service.transunion.com/dss/ccpa_optout.page) and submit.
