...
### ☠ 💐 Nuwber
[Find your information](https://nuwber.com/). Try to opt out on the [removal form](https://nuwber.com/removal/link). If the URL you generate doesn't work in the form or you run across other problems, take a screenshot of your results and send them to <support@nuwber.com>, asking them to opt you out. (Try "filter by state" to isolate the "person" URL you need. Don't bother trying to get a full report, it'll just waste your time with several steps and dark patterns trying to get you to create a paid subscription.) 
...
### ☠ 💐 PeopleFinders
[Find your information](https://www.peoplefinders.com/) and [opt out](https://www.peoplefinders.com/opt-out). This includes Advanced People Search. The opt-out link also includes information on finding your profile, after you hit next. You will need to confirm your opt-out request by clicking on a link sent to you via email. (It may be easier to go straight to the opt out form; after a general search the site will try to get you to pay for a full report.)
...
### ☠ 💐 Spokeo
Find [your information](https://www.spokeo.com/search) and remove your information by entering the URL of the profile you want removed and your email address on the [opt-out page](https://www.spokeo.com/optout). Make sure to scroll down to the opt out section. You will need to solve a captcha, and then confirm your opt-out request by clicking on a link sent to you via email. That link will take you back to the page with a form, but if you scroll down, you'll see a note confirming the request.
