...
To remove yourself from other methods of targeted advertising, visit their [privacy opt-out page](https://www.experian.com/privacy/opting_out) and follow the links for each opt-out method.
...
### ☠ 💐 LexisNexis
Follow the prompts in the [opt-out form](https://optout.lexisnexis.com/). Provide the required information depending on the option selected at the 'Opt Out Reason' step.
